...
export interface IAlephGatewayPipelineStackProps extends cdk.StackProps {
...
export default class AlephGatewayPipelineStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props: IAlephGatewayPipelineStackProps) {
    ...
    const codebuildRole = new AlephGatewayBuildRole(this, 'CodeBuildTrustRole', {
    ...
    // DEPLOY TO TEST
    const deployToTestProject = new AlephGatewayBuildProject(this, 'AlephGatewayTestBuildProject', {
      ...props,
      stage: 'test',
      role: codebuildRole,
    })
    ...
    // DEPLOY TO PROD
    const deployToProdProject = new AlephGatewayBuildProject(this, 'AlephGatewayProdBuildProject', {
      ...props,
      stage: 'prod',
      role: codebuildRole,
    })
