...
export interface IAlephGatewayBuildProjectProps extends codebuild.PipelineProjectProps {
...
export default class AlephGatewayBuildProject extends codebuild.PipelineProject {
  constructor(scope: cdk.Construct, id: string, props: IAlephGatewayBuildProjectProps) {
