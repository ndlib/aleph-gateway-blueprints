...
export interface IAlephGatewayQaProjectProps {
  readonly stage: string
  readonly role: Role
}

export class AlephGatewayQaProject extends PipelineProject {
  constructor(scope: Construct, id: string, props: IAlephGatewayQaProjectProps) {
        ...
        phases: {
          ...
          build: {
            commands: [
              ...
              `newman run ./tests/postman/qa_collection.json --env-var alephGatewayApiUrl=$API_URL`,
            ],
          },
        },
      }),
...
export default AlephGatewayQaProject
